          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-4" id="header-right">
                ...
                <?php if ($logged) { ?>
                <div class="my-account-with-logout"> <a href="<?php echo $account; ?>" onclick="window.location.href = '<?php echo $account; ?>'" class="my-account" data-hover="dropdown" data-toggle="dropdown"><i class="fa fa-user"></i></a>
