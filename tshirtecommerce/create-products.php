...
$is_admin = true; // fix load

session_start();
if ( isset($_SESSION['designer']) && isset($_GET['token']))
{
	$designer = $_SESSION['designer'];
	
	$token	= $_GET['token'];
	$code 	= md5($designer['email'].$designer['password']);
	if ($code == $token)
	{
		$is_admin = true;
		$code		= md5($designer['id']);
		setcookie('design', $code, time() + (86400 * 1000), "/");
	}
}
...
<head>
	...
	<link type="text/css" href="assets/css/designer-admin.css" rel="stylesheet" media="all">
	<link type="text/css" href="assets/plugins/perfect-scrollbar/perfect-scrollbar.css" rel="stylesheet" media="all">
	
	<link type="text/css" href="assets/plugins/stores/bootstrap-datepicker.min.css" rel="stylesheet" media="all">	
	<link type="text/css" href="assets/plugins/stores/jquery.tagsinput.css" rel="stylesheet" media="all">	
	
	<link type="text/css" href="assets/plugins/stores/summernote.css" rel="stylesheet" media="all">
	...
	<script src="<?php echo 'assets/js/designer-admin.js'; ?>" type="text/javascript" charset="utf-8"></script>	
...
<body>	
	...
	<?php } ?>
	<script type="text/javascript" src="assets/plugins/stores/bootstrap-datepicker.min.js"></script>
	<script type="text/javascript" src="assets/plugins/stores/jquery.tagsinput.js"></script>
	<script type="text/javascript" src="assets/plugins/stores/summernote.min.js"></script>
