...
if (setValue($settings, 'show_languages', 1) == 1)
{
	...
	<button type="button" class="btn btn-default btn-sm btn-desktop" title="<?php echo $addons->__('addon_languag_title_'.$lang_default->code); ?>" onclick="jQuery('.languages-modal').modal('show');">
