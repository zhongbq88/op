							...
							<div class="panel panel-default">
								...
								<div id="tabs" class="tabs-left panel-body">
									<ul class="tabs-nav-left col-md-3">
										<li><a href="#tabs-1" data-toggle="tab" aria-expanded="true"><?php lang('product_general'); ?></a></li>
										<li><a href="#tabs-3" data-toggle="tab" aria-expanded="true"><?php lang('product_attribute'); ?></a></li>
									</ul>
									<div class="tabs-content-right col-md-9">
										<div id="tabs-1">
											...
											<div class="form-group">
												...
												<div class="col-sm-offset-3 col-sm-9">
													<p>Note: Calculate price of printing based printing type. Go to menu <strong>T-Shirt eCommerce > Printing Type</strong> add or edit printing type.</p>
												</div>
											</div>
											<?php 
										...
										<div id="tabs-2" style="display: none!important;">
											<div class="form-group">
						...
						<div class="tab-pane" id="panel_tab2_example2">
							<div class="form-group">
								<div class="alert alert-block alert-warning">
									Change size of box design after config images, area design of front, back, left, right.
								</div>
								<strong>Width:</strong> <input type="text" name="product[box_width]" class="box_width form-control input-sm" style="width:100px;display: inline;" value="<?php echo setValue($product, 'box_width', 500); ?>">px; 
								<strong>Height:</strong> <input type="text" name="product[box_height]" class="box_height form-control input-sm" style="width:100px;display: inline;" value="<?php echo setValue($product, 'box_height', 500); ?>">px
							</div>
								...
								<table class="table table-bordered table-hover" id="product-design">
									<thead>
										<tr>
											...
											<th rowspan="2" class="center" width="5%">Price Extra <small>(+/-)</small></th>
