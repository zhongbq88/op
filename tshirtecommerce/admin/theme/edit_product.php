					...
					<div class="panel panel-default">
						...
						<div id="tabs" class="tabs-left panel-body">
							<ul class="tabs-nav-left col-md-3">
								...
								<li style="display: none!important;"><a href="#tabs-2"><?php lang('product_order'); ?></a></li>
								...
								<div id="tabs-1">
									...
									<div class="form-group">
										...
										<div class="col-sm-offset-3 col-sm-9">
											<p>Note: Calculate price of printing based printing type. <a href="<?php echo site_url('index.php/printing'); ?>">Setup Printing type</a></p>
										</div>
									</div>
									...
									<div class="form-group" id="prices-quantity">
										...
										?>
										<div class="row-prices">
											<label class="col-xs-3 control-label"><?php lang('product_quantity_price'); ?></label>
											<div class="col-sm-9">
												<div class="form-group row">
													<div class="col-xs-5">
