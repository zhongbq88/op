						...
						<div class="row">
							<div class="col-md-6">
								<select class="form-control" onchange="store.art.categories(this);">
									...
									<option <?php if($cate_id == $cate['id']) echo 'selected="selected"'; ?> value="<?php echo $cate['id']; ?>"><?php echo $cate['title']; ?></option>
									<?php } ?>
								</select>
							</div>
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-md-4">
							...
							<p>Type: <strong><?php echo $art['type']; ?></strong></p>
							<p>Designer: <a href="http://store.9file.net/user/cliparts/<?php echo $art['username']; ?>" title="View Profile" target="_blank"><strong><?php echo $art['username']; ?></strong></a></p>
						</div>
