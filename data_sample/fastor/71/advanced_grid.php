      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'html' => 
            array (
              1 => '<div class="row footer-blocks-top-toys2" style="margin-top: 24px">
     <div class="col-sm-4">
          <div class="footer-block-toys2">
               <img src="image/catalog/stationery2/icon-phone2.png" alt="Phone">
               <div class="footer-block-content">
                    <h6 style="color: #ffa800;font-weight: normal;">Call us</h6>
                    <p style="color: #262626;font-weight: normal;">+48 500-500-100</p>
               </div>
          </div>
     </div>
     ...
     <div class="col-sm-5">
          <div class="footer-block-toys2">
               ...
               <div class="footer-block-content">
                    ...
                    <p style="color: #262626;font-weight: normal;">contact@example.com</p>
               </div>
          </div>
     </div>
...
',
              $language_id => '<div class="row footer-blocks-top-toys2" style="margin-top: 24px">
     <div class="col-sm-4">
          <div class="footer-block-toys2">
               <img src="image/catalog/stationery2/icon-phone2.png" alt="Phone">
               <div class="footer-block-content">
...
',
  ...
  array (
    ...
    'background_image' => 'catalog/fishing/bg-parallax.jpg',
