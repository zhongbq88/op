...
<ul class="social-icons-default" style="padding-top: 7px">
     ...
     <div class="col-sm-4">
          <div class="footer-block-toys2">
               ...
               <div class="footer-block-content">
                    <h6 style="color: #f44c1c">Call us</h6>
                    <p style="color: #262626">+48 500-500-100</p>
               </div>
          </div>
     </div>
     ...
     <div class="col-sm-5">
          <div class="footer-block-toys2">
               ...
               <div class="footer-block-content">
                    <h6 style="color: #f44c1c">Or send e-mail</h6>
                    <p style="color: #262626">contact@example.com</p>
               </div>
          </div>
     </div>
...
<div class="row banners banners-with-padding-45">
     <div class="col-sm-8"><a href="#"><img src="image/catalog/stationery2/banner-03.png" alt="Banner"></a></div>
     <div class="col-sm-4"><a href="#"><img src="image/catalog/stationery2/banner-04.png" alt="Banner"></a></div>
</div>
',
...
',
  ...
  array (
    ...
    'background_image' => 'catalog/stationery2/bg-parallax.jpg',
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'html' => 
            array (
              1 => '<div class="stationery2-parallax2">
     <div class="first-heading">Back to school!</div>
     <div class="second-heading">On sale now!</div>
     <a href="#" class="button">Read more</a>
</div>

<link href=\'https://fonts.googleapis.com/css?family=Shadows+Into+Light\' rel=\'stylesheet\' type=\'text/css\'>',
              $language_id => '<div class="stationery2-parallax2">
     <div class="first-heading">Back to school!</div>
     <div class="second-heading">On sale now!</div>
     <a href="#" class="button">Read more</a>
</div>
...
<link href=\'https://fonts.googleapis.com/css?family=Shadows+Into+Light\' rel=\'stylesheet\' type=\'text/css\'>',
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/stationery2/bg-parallax2.jpg',
    'background_image_position' => 'top center',
    'background_image_repeat' => 'no-repeat',
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'html' => 
            array (
              1 => '<div class="stationery2-parallax">
     <div class="first-heading">Need help?</div>
     <div class="second-heading">Looking for inspiration?</div>
     <a href="#" class="button">Read more</a>
</div>

<link href=\'https://fonts.googleapis.com/css?family=Shadows+Into+Light\' rel=\'stylesheet\' type=\'text/css\'>',
              $language_id => '<div class="stationery2-parallax">
     <div class="first-heading">Need help?</div>
     <div class="second-heading">Looking for inspiration?</div>
     <a href="#" class="button">Read more</a>
</div>
