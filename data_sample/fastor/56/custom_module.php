...
$output["custom_module_module"] = array (
  ...
  array (
    ...
    array (
     ...
     <div class="col-sm-6"><a href="#"><img src="image/catalog/computer6/banner-01.png" alt="Banner"></a></div>
     <div class="col-sm-6"><a href="#"><img src="image/catalog/computer6/banner-02.png" alt="Banner"></a></div>
</div>',
  ...
  array (
    ...
    'html' => 
    array (
      1 => '<div style="height: 358px" class="hidden-xs hidden-sm"></div>',
      $language_id => '<div style="height: 358px" class="hidden-xs hidden-sm"></div>',
    ),
    'layout_id' => '3',
