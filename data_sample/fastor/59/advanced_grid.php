...
<a href="#"><img src="image/catalog/petshop/banner-04.png" style="margin-top: 35px;display: block;margin-bottom: -7px;position: relative" class="responsive-margin-top-30 responsive-margin-bottom-15" alt="Banner"></a>',
...
<a href="#"><img src="image/catalog/petshop/banner-04.png" style="margin-top: 35px;display: block;margin-bottom: -7px;position: relative" class="responsive-margin-top-30 responsive-margin-bottom-15" alt="Banner"></a>',
  ...
  array (
    ...
    'background_image' => 'catalog/petshop/bg-food-tips.png',
    ...
    array (
     ...
     <div style="float:right;max-width: 457px;width: 100%">
          <div class="food-tips">
               <div class="first-heading">Food for your pet<br><strong>10 best products</strong></div>
