...
<a href="#"><img src="image/catalog/tools2/banner-04.png" style="margin-top: 35px;display: block;margin-bottom: -7px;position: relative" class="responsive-margin-top-30 responsive-margin-bottom-15" alt="Banner"></a>',
              $language_id => '<div class="shoes2-contact">
     <div class="row">
          <div class="col-sm-4">
               <img src="image/catalog/shoes2/icon-phone2.png" alt="Phone">
               <p>500-120-111</p>
...
<a href="#"><img src="image/catalog/tools2/banner-04.png" style="margin-top: 35px;display: block;margin-bottom: -7px;position: relative" class="responsive-margin-top-30 responsive-margin-bottom-15" alt="Banner"></a>',
  ...
  array (
    ...
    'background_image' => 'catalog/tools2/bg-inspiration.png',
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'html' => 
            array (
              1 => '<div class="tools2-looking">
     <div class="first-heading">Check our<br><strong>Interior Inspiration</strong></div>
     <a href="#" class="button btn-default tools2-button">Read more</a>
</div>
',
              $language_id => '<div class="tools2-looking">
     <div class="first-heading">Check our<br><strong>Interior Inspiration</strong></div>
     <a href="#" class="button btn-default tools2-button">Read more</a>
</div>
',
